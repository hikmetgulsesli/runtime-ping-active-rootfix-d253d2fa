...
- Runtime Ping Active Rootfix turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page status tile app called Runtime Ping Active Rootfix. It should show three status cards, a live timestamp, and one reset button. Keep it simple for pipeline testing. REPO: /Users/setrox/projects/runtime-ping-active-rootfix-20260629-225216. Frontend port: 3622
...
- Record Operations - Runtime Ping Active Rootfix
- Record Editor - Runtime Ping Active Rootfix
- Pipeline Board - Runtime Ping Active Rootfix
- Insights - Runtime Ping Active Rootfix

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Runtime Ping Active Rootfix
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Runtime Ping Active Rootfix
...
SCREEN_SPEC_3:
- exact_screen_title: Pipeline Board - Runtime Ping Active Rootfix
...
SCREEN_SPEC_4:
- exact_screen_title: Insights - Runtime Ping Active Rootfix
